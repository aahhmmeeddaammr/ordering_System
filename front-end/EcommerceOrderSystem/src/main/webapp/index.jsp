        ...
        <body>
            ...
            <section class="hero">
                <div class="container">
                    ...
                    <p class="hero-subtitle">Discover our collection of high-quality electronics. Fast delivery, great
                        prices, excellent service.</p>
                </div>
            </section>
            ...
            <script>
                ...
                function addToCart(productId) {
                    var product = productsData.find((product) => product.product_id === productId);
